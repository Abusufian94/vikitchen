                ...
                <div class="container">
                    <div class="row">
                        <div class="footer-widget col-lg-4 col-12 mb-lg-0 mb-4 pr-lg-4">
                            <img class="footer-logo" src="img/logo--dark.png" alt="Mullar">
...
Tollygunge, Kolkata, Pin- 700082</span></li>
                                <li><i class="fa fa-phone"></i><span> +91 7300000009</span></li>
                                <li><i class="fa fa-envelope-open"></i><span>fromfutction@gmail.com</span></li>
                            </ul>
                            <ul class="social">
                                <li>
