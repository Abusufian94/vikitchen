        ...
        <div class="page-contaiter">
           ...
           <section id="intro" class="intro">
                    ...
                    <div class="intro_slider1 owl-carousel owl-theme">
                       ...
                       <div class="item"><img src="img/slide_img/slide2.jpg" style="width:100%;"></div>
                       <div class="item"><img src="img/slide_img/slide4.jpg" style="width:100%;"></div>
                       <div class="item"><img src="img/slide_img/slide5.jpg" style="width:100%;"></div>
                       <div class="item"><img src="img/slide_img/slide6.jpg" style="width:100%;"></div>
                    ...
                    <div class="row nf-grid">
                            ...
                            <div class="categories-item categories-item_1">
                                <div class="categories-image">
                                    <a class="categories-img-link">
                                        <img src="img/categories/imgb1.jpg" alt="Women Accesories" />
                                    </a>
                                </div>
                                <div class="categories-content-overlay">
                                    <a class="categories-caption categories-caption-bottom slide-after-sec-btn" href="product_listing.php">Kitchen Chimney</a>
                                </div>
                            </div>
                        </div>
                        <!--Grid-->
                        <div class="col-lg-4 col-md-6 col-sm-12 nf-grid-item">
                            ...
                            <div class="categories-item categories-item_1">
                                <div class="categories-image">
                                    <a class="categories-img-link">
                                        <img src="img/categories/imgs1.jpg" alt="Women Accesories" />
                                    </a>
                                </div>
                                <div class="categories-content-overlay">
                                    <a class="categories-caption categories-caption-bottom slide-after-sec-btn" href="#">Hobs</a>
                                </div>
                            </div>
                        </div>
                        <!--Grid-->
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12 nf-grid-item">
                            ...
                            <div class="categories-item categories-item_1">
                                <div class="categories-image">
                                    <a class="categories-img-link">
                                        <img src="img/categories/imgb.jpg" alt="Women Accesories" />
                                    </a>
                                </div>
                                <div class="categories-content-overlay">
                                    <a class="categories-caption categories-caption-bottom slide-after-sec-btn" href="#">Hobs</a>
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12 nf-grid-item">
                            ...
                            <div class="categories-item categories-item_1">
                                ...
                                <div class="categories-content-overlay">
                                    <a class="categories-caption categories-caption-bottom slide-after-sec-btn" href="#">Bosch</a>
                                </div>
                            </div>
                        </div>
                        <!--Grid-->
                        <div class="col-lg-4 col-md-6 col-sm-12 nf-grid-item">
                            ...
                            <div class="categories-item categories-item_1">
                                ...
                                <div class="categories-content-overlay">
                                    <a class="categories-caption categories-caption-bottom slide-after-sec-btn" href="#">Hafele</a>
                                </div>
                            </div>
                        </div>
                        <!--Grid-->
            ...
            <section id="intro" class="intro">
                    ...
                    <div class="intro_slider1 owl-carousel owl-theme">
                       ...
                       <div class="item"><img src="img/slide_img/offer.jpg" style="width:100%;"></div>
                       <div class="item"><img src="img/slide_img/offer2.jpg" style="width:100%;"></div>
                       <!--<div class="item"><img src="img/slide_img/slide3.jpg" style="width:100%;"></div>
                       <div class="item"><img src="img/slide_img/img_002.jpg" style="width:100%;"></div>-->
                    </div>
                    <!--End Slider Hero-->
